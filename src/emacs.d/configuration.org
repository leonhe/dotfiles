...
(defhydra cesco/hydra ()
  "
  ^Window^        ^Hugo^            ^GIT^           ^Others^
----------------------------------------------------------------------------------------
[_=_] Zoom IN   [_h_] Posts     [_p_] Auto-PUSH    [_d_] Kill all Buffers
[_-_] Zoom Out  [_H_] Tabs      [_g_] Repo's List  [_p_] Mark all
^ ^             [_C-p_] Preview [_g_] Edit lines   [_p_] Mark by regexp
"
