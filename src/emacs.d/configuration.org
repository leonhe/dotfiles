...
(use-package spaceline :ensure t
  ...
  (set-face-attribute 'mode-line-buffer-id nil :background "#8b0000")
  (set-face-attribute 'mode-line-p  nil :background "#8b0000")
...
(projectile-root  :separator "  ")
     ((remote-host buffer-id) :face mode-line-buffer-id )
(nyan-cat)
   (process :when active))
