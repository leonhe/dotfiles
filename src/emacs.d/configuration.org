...
----------------------------------------------------------------------------------------
[_=_] Zoom IN   [_h_] Posts      [_p_] Auto-PUSH   [_p_] Auto-PUSH    [_d_] Kill all Buffers
[_-_] Zoom Out  [_H_] Tabs       [_p_] Auto-PUSH   [_g_] Repo's List  [_p_] Mark all
^ ^             [_C-p_] Preview  [_p_] Auto-PUSH
"
