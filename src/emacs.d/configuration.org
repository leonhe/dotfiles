...
* TODOS
** TODO refactor whole file to use skeeto/with-package hack
...
(use-package hl-line+
  ...
  (hl-line-when-idle-interval 300)
...
("c" flyspell-buffer "Automatic push" :color blue )
...
(global-set-key[(shift control e)] 'cesco/hydra/body)
